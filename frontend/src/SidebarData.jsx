...
export const sidebarData = {
  ADMIN: [
    ...
    { name: "Syllabus Tracking", path: "/syllabustracking", icon: <IoAnalyticsSharp size={18} /> },
    ...
    { name: "Settings", path: "/settings", icon: <RiSettingsLine size={18} /> },
  ],
  ...
  TEACHER: [
    ...
    { name: "Students Attendance", path: "/students/attendance", icon: <RiBookShelfFill size={18} /> },
    { name: "Settings", path: "/settings", icon: <RiSettingsLine size={18} /> },
  ]
};